    ...
    <div class="l-wrapper">
        ...
        <div class="ly_container_contact l-main-contents">
            ...
            <input type="hidden" name="token" value="<?php echo $token; ?>">
                <div class="bl_form">
                <label class="bl_form_label"><span class="ttl">種別</span><span class="must">*必須</span></label>
                <div class="sentaku-wrapper">
                    <label><input type="radio" name="sentaku" value="新卒" data-errmsg="種別が未選択です。" <?php if (isset($_POST['sentaku']) && $_POST['sentaku'] === '新卒') echo 'checked'; ?>> 新卒</label>
                    <label><input type="radio" name="sentaku" value="中途採用" <?php if (isset($_POST['sentaku']) && $_POST['sentaku'] === '中途採用') echo 'checked'; ?>> 中途採用</label>
                </div>
                <p id="sentaku_error" class="form-check form-caution text-danger bg-text-danger" style="display: block;"></p>
                </div>
                <!-- /.bl_form -->
                <div class="bl_form">
                ...
                <!-- /.bl_form -->
                <div class="bl_form">
                <label for="InputZip" class="bl_form_label"><span class="ttl">郵便番号</span></label>
                <input type="text" class="form-control sizefull" id="InputZip" name="zip" placeholder="例）⚪︎⚪︎⚪︎-⚪︎⚪︎⚪︎⚪︎" style="width: 170px;" value="<?php echo isset($_POST['zip']) ? htmlspecialchars($_POST['zip'], ENT_QUOTES, 'UTF-8') : ''; ?>"><button type="button" class="zip-btn" disabled>住所検索</button>
                <div id="zip_error" class="form-check form-cautoin text-danger bg-text-danger"></div>
                </div>
                <!-- /.bl_form --> 
                <div class="bl_form">
                <label for="InputPrefecture" class="bl_form_label"><span class="ttl">住所（都道府県）</span></label>
                <input type="text" class="form-control sizefull" id="InputPrefecture" name="prefecture" value="<?php echo isset($_POST['prefecture']) ? htmlspecialchars($_POST['prefecture'], ENT_QUOTES, 'UTF-8') : ''; ?>">
                <div id="prefecture_error" class="form-check form-cautoin text-danger bg-text-danger"></div>
                </div>
                <!-- /.bl_form --> 
                <div class="bl_form">
                <label for="InputCity" class="bl_form_label"><span class="ttl">住所（郡市町）</span></label>
                <input type="text" class="form-control sizefull" id="InputCity" name="city" value="<?php echo isset($_POST['city']) ? htmlspecialchars($_POST['city'], ENT_QUOTES, 'UTF-8') : ''; ?>">
                <div id="city_error" class="form-check form-cautoin text-danger bg-text-danger"></div>
                </div>
                <!-- /.bl_form --> 
                <div class="bl_form">
                <label for="InputStreet" class="bl_form_label"><span class="ttl">住所（番地）</span></label>
                <input type="text" class="form-control sizefull" id="InputStreet" name="street" value="<?php echo isset($_POST['street']) ? htmlspecialchars($_POST['street'], ENT_QUOTES, 'UTF-8') : ''; ?>">
                <div id="street_error" class="form-check form-cautoin text-danger bg-text-danger"></div>
                </div>
                <!-- /.bl_form -->  
                <div class="bl_form">
                <label for="InputBuilding" class="bl_form_label"><span class="ttl">住所（マンション・アパート・建物）</span></label>
                <input type="text" class="form-control sizefull" id="InputBuilding" name="building" value="<?php echo isset($_POST['building']) ? htmlspecialchars($_POST['building'], ENT_QUOTES, 'UTF-8') : ''; ?>">
                <div id="building_error" class="form-check form-cautoin text-danger bg-text-danger"></div>
                </div>
                <!-- /.bl_form -->   
                <div class="bl_form">
                <label for="InputFax" class="bl_form_label"><span class="ttl">FAX番号</span></label>
                <input type="text" class="form-control sizefull" id="InputFax" name="fax" value="<?php echo isset($_POST['fax']) ? htmlspecialchars($_POST['fax'], ENT_QUOTES, 'UTF-8') : ''; ?>">
                <div id="Fax_error" class="form-check form-cautoin text-danger bg-text-danger"></div>
                </div>
                <!-- /.bl_form -->
                <div class="bl_form">
                ...
                <input type="text" class="form-control" id="InputSchool" name="school" placeholder="例）●●大学" value="<?php echo isset($_POST['school']) ? htmlspecialchars($_POST['school'], ENT_QUOTES, 'UTF-8') : ''; ?>">
                </div>
                <!-- /.bl_form -->
                <div class="bl_form">
                <label for="InputFaculty" class="bl_form_label"><span class="ttl">専攻学部</span></label>
                <input type="text" class="form-control" id="InputFaculty" name="faculty" placeholder="例）●●学部" value="<?php echo isset($_POST['faculty']) ? htmlspecialchars($_POST['faculty'], ENT_QUOTES, 'UTF-8') : ''; ?>">
                </div>
                <!-- /.bl_form -->
                <div class="bl_form">
                <label for="InputGraduate" class="bl_form_label"><span class="ttl">卒業（卒業予定）</span><span class="must">*必須</span></label>
                <input type="month" class="form-control" id="InputGraduate" name="graduate" value="<?php echo isset($_POST['graduate']) ? htmlspecialchars($_POST['graduate'], ENT_QUOTES, 'UTF-8') : ''; ?>" required>
                <div id="graduate_error" class="form-check"></div>
                </div>
                <!-- /.bl_form -->
                        
                <div class="bl_form">
                <label for="Inputinquiry" class="bl_form_label"><span class="ttl">自己PR・質問等</span><span class="must">*必須</span></label>
                <textarea class="form-control" name="inquiry" id="Inputinquiry" rows="10" placeholder="" data-errmsg="自己PR・質問等が未入力です。"  required><?php echo isset($_POST['inquiry']) ? htmlspecialchars($_POST['inquiry'], ENT_QUOTES, 'UTF-8') : ''; ?></textarea>
                ...
                <div class="btn-wrapper center">
                    <input class="contact-btn" type="submit" id="confirm" name="confirm" value="応募内容を確認"/>
                </div>
